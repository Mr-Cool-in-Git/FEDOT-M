...
from fedot.api.meta.meta import MetaRecommender
...
class Fedot:
    ...
    def __init__(self,
        ...
        self.meta_recommender = MetaRecommender()
        # Input params
        ...
        #update meta
        #if len(data_to_meta.columns) != 0:
        self.recommend_composer_params = self.meta_recommender.recommend_params(data_to_meta)
        input_params['composer_params'] = self.recommend_composer_params

        #input_params composer_params preset
